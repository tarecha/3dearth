...
scatter3(kolomTengah, barisTengah,ztitik+2,100,'g','^','filled');
...
clearvars -except ww View waktu luas barisKoma barisMatriks kolomKoma kolomMatriks zmax zmin ztitik infoMemory jumlahPohon errorlog luasWilayahAir statusPotong;
%end
