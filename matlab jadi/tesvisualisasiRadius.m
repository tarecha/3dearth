%function [View,waktu,luas,barisKoma,barisMatriks,kolomKoma,kolomMatriks,zmax,zmin,ztitik,infoMemory,jumlahPohon,errorlog,luasWilayahAir] = visualisasiRadius(nama, latitude , longitude, radius, seleksi,interpolasi,pohon,deteksiAir)

clear all;
clc
nama = 'deteksi wilayah air gunung rinjani';
%rinjani
latitude=-8.408748255096551 ;
longitude=116.40906303440421;

%semeru
%latitude=-8.118753107629853;
%longitude=112.92196136546262;

%waduk karangkates -8.18338663470151, 112.48233072897904

%latitude=-8.164;
%longitude=112.48;


%rinjani -8.401782553201073, 
%semeru -8.118753107629853, 112.92196136546262
%-8.308096732903124, 112.
% latitude2=	-8.005824;
%longitude2=	113.0109;
radius =200;
seleksi = 'RHD';
...
%clearvars -except b View waktu luas barisKoma barisMatriks kolomKoma kolomMatriks zmax zmin ztitik infoMemory jumlahPohon errorlog luasWilayahAir;
%end
